...
theme.font                                      = "FontAwesome 10.5"
theme.icons_font_custom				= "FontAwesome 8"
...
local mytextclock = wibox.widget.textclock("<span font='Terminus 5'> </span>  %A, %b %d %H:%M ")
...
-- MEM
local memicon = wibox.widget.imagebox(theme.disk)
local memory = lain.widget.mem({
    settings = function()
        widget:set_markup(markup.fontfg(theme.icons_font_custom, "#78A4FF", mem_now.used .. "M "))
    end
})
...
theme.weather = lain.widget.weather({
    city_id = 3186886, -- (Zagreb)
    notification_preset = { font = "FontAwesome 10.5", fg = theme.fg_normal },
    weather_na_markup = markup.fontfg(theme.font, "#78A4FF", "N/A "),
    settings = function()
        descr = weather_now["weather"][1]["description"]:lower()
        units = math.floor(weather_now["main"]["temp"])
        widget:set_markup(markup.fontfg(theme.icons_font_custom, "#78A4FF", "  " .. descr .. " " .. units .. "°C "))
    end
})
...
local netdowninfo = lain.widget.net({
	settings = function ()
	widget:set_markup(markup.fontfg(theme.icons_font_custom, "#78A4FF", "  " .. net_now.received .. " "))
	end
})
...
local netupinfo = lain.widget.net({
    settings = function()
        ...
        widget:set_markup(markup.fontfg(theme.icons_font_custom, "#78A4FF", "  " .. net_now.sent .. " "))
    end
})
